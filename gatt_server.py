...
class Application(dbus.service.Object):
    ...
    def __init__(self, bus):
        ...
        self.add_service(LetterService(bus, 0))
...
class Descriptor(dbus.service.Object):
    ...
    def WriteValue(self, value, options):
        print('Default WriteValue called, returning error')
        raise exceptions.NotSupportedException()
class LetterService(Service):
    """
    GATT Service for sending and receiving letters.
    """
    LETTER_UUID = '12345678-1234-5678-1234-56789abcdef0'

    def __init__(self, bus, index):
        Service.__init__(self, bus, index, self.LETTER_UUID, True)
        self.add_characteristic(SendLetterCharacteristic(bus, 0, self))
        self.add_characteristic(ReceiveLetterCharacteristic(bus, 1, self))

class SendLetterCharacteristic(Characteristic):
    SEND_LETTER_UUID = '12345678-1234-5678-1234-56789abcdef1'

    def __init__(self, bus, index, service):
        Characteristic.__init__(self, bus, index, self.SEND_LETTER_UUID,
                                ['read', 'write'], service)
        self.value = []
...
class ReceiveLetterCharacteristic(Characteristic):
    ...
    def __init__(self, bus, index, service):
        Characteristic.__init__(self, bus, index, self.RECEIVE_LETTER_UUID,
                                ['read', 'write'], service)
        self.value = []
    ...
    @dbus.service.method(GATT_CHRC_IFACE,
                         ...
                         out_signature='ay')
    def ReadValue(self, options):
        print('ReceiveLetterCharacteristic ReadValue called')
        return dbus.ByteArray(self.value)
